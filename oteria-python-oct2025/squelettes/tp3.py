...
# Objectif : Tester toutes les permutations possible de message à 3 caractères et répondre à un calcul
#            à partir de 300 essais manqués
...
def bruteforce(session_id):
    ...
    # TODO : Renvoyer une bonne réponse en cas de captcha
